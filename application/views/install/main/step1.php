      ...
      <div class="card-body">
        <div class="panel panel-default" data-collapsed="0"
          style="border-color: #dedede;">
            ...
            <?php if ($valid == true) { ?>
              <p>
                <?php if ($_SERVER['SERVER_NAME'] == 'localhost' || $_SERVER['SERVER_NAME'] == '127.0.0.1' || $_SERVER['SERVER_NAME'] == 'http://neo.justflyawaydeals.com' || $_SERVER['SERVER_NAME'] == 'http://justflyawaydeals.com' || $_SERVER['SERVER_NAME'] == 'https://neo.justflyawaydeals.com' || $_SERVER['SERVER_NAME'] == 'https://justflyawaydeals.com' || $_SERVER['SERVER_NAME'] == 'neo.justflyawaydeals.com') { ?>
